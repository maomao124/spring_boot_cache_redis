package mao.spring_boot_cache_redis.controller;


import com.baomidou.mybatisplus.core.metadata.IPage;
import mao.spring_boot_cache_redis.entity.Book;
import mao.spring_boot_cache_redis.entity.Result;
import mao.spring_boot_cache_redis.service.IBookService;
...
public class BookController
{
    ...
    {
        return new Result(true, this.bookService.getBookById(id));
    }
